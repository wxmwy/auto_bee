...
def load():
    ...
    # path of pipe
    PIPE_PATH = (
        'assets/bee/plant1.png',
        'assets/bee/plant2.png',
        'assets/bee/plant3.png',
        'assets/bee/plant4.png',
    )


    IMAGES, SOUNDS, HITMASKS = {}, {}, {}

    IMAGES['score'] = pygame.image.load('assets/bee/score.png').convert_alpha()
    IMAGES['end'] = pygame.image.load('assets/bee/end.png').convert_alpha()
    IMAGES['start'] = pygame.image.load('assets/bee/start.png').convert_alpha()
    ...
    IMAGES['background'] = pygame.image.load('assets/bee/bg.png').convert()
